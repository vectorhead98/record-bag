  ...
  return (
    <Label
      ...
      className={cn(
        ...
        `,
        `
        has-data-checked:bg-primary/5 dark:has-data-checked:bg-primary/10
        *:data-[slot=field]:p-2 group-data-[disabled=true]/field:opacity-50
        `,
        `
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        `
        text-left text-xs/relaxed text-muted-foreground leading-normal font-normal
        `,
        `
