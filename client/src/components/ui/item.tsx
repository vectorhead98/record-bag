...
const itemVariants = cva(
  [
    `
    group/item flex w-full flex-wrap items-center rounded-md border
    text-xs/relaxed transition-colors duration-100 outline-none
    `,
    `
  ...
  ],
  {
    variants: {
      variant: {
        ...
        image: `
          size-8 overflow-hidden rounded-sm
  ...
  return (
    <div
      ...
      className={cn(
        ...
        text-xs/relaxed leading-snug font-medium underline-offset-4
        `,
        className
      )}
      {...props}
...
function ItemDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        `
        line-clamp-2 text-left text-xs/relaxed font-normal text-muted-foreground
        `,
        `
