  ...
  return (
    <ToastPrimitive.Viewport
      ...
      className={cn(
        ...
        mx-auto w-auto max-w-sm outline-none
        `,
        `
...
function Toast({ className, ...props }: ToastPrimitive.Root.Props) {
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        `
        group/toast pointer-events-auto absolute right-0 bottom-0
        ...
        `,
        `
        [--gap:0.75rem] [--peek:0.75rem] [--shrink:calc(1-var(--scale))]
        ...
        `,
        `
        data-expanded:h-(--toast-height) data-limited:opacity-0 data-starting-style:transform-[translateY(150%)]
