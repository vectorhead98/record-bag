  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          `
          fixed md:flex inset-y-0 z-10 hidden h-svh w-(--sidebar-width)
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        `
        absolute sm:flex inset-y-0 z-20 hidden w-4
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          ...
          text-sidebar-foreground/70 outline-hidden
    ...
    props: mergeProps<"button">(
      {
        className: cn(
          `
          absolute top-3.5 right-3 flex items-center justify-center
...
const sidebarMenuButtonVariants = cva(
  ...
  overflow-hidden rounded-[calc(var(--radius-sm)+2px)] p-2
  text-left text-xs ring-sidebar-ring outline-hidden
    ...
    props: mergeProps<"button">(
      {
        className: cn(
          `
          absolute top-1.5 right-1 flex aspect-square w-5
          items-center justify-center rounded-[calc(var(--radius-sm)-2px)] p-0
          text-sidebar-foreground ring-sidebar-ring outline-hidden
          transition-transform
          group-data-[collapsible=icon]:hidden
  ...
  return (
    <div
      ...
      className={cn(
        ...
        items-center justify-center rounded-[calc(var(--radius-sm)-2px)] px-1
